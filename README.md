...
If neither `WINDOWS_STORE_IDENTITY_NAME` nor `WINDOWS_STORE_PUBLISHER` is configured, artifact builds fall back to `TWhitehead.PasswordTreeGold` and `CN=A969D4FD-73DD-4CCC-9D50-DE06393026F3`.
